...
def generate_xml_namespace():
    ...
    # https://stackoverflow.com/questions/31864133/how-to-insert-namespace-and-prefixes-into-an-xml-string-with-python

    return doc.toprettyxml()

def append_string_to_file(data: str, filename: str):
    text_file = open("./out/" + filename, "a")
    text_file.write(data)
    text_file.close()


def write_string_to_file(data: str, filename: str):
...
def write_xml_to_file(root: ET.Element, filename: str):
...
def create_simple_xml():
    ...
    write_xml_to_file(root, 'person.xml')
...
def create_customer_order():
    ...
    write_xml_to_file(root, 'order.xml')
...
def create_dict_to_xml():
  ...
  "types": [
    ...
    root_name = 'foobar'
    xml = dicttoxml.dicttoxml(a, xml_declaration=False)
    # print(xml)
    # xml = dicttoxml.dicttoxml(a, custom_root=root_name, xml_declaration=False)
    dom = parseString(xml)
    # namespace = generate_xml_namespace()
    write_string_to_file('', 'dict_data.xml')
    # write_string_to_file(namespace, 'dict_data.xml')
    append_string_to_file(dom.toprettyxml(), 'dict_data.xml')
