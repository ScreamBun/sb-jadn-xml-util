...
NUMBER_CONST = "Number"
STRING_CONST = "String"
PRIMITIVES = (BINARY_CONST, BOOLEAN_CONST, INTEGER_CONST, NUMBER_CONST, STRING_CONST)
# Selectors
ENUMERATED_CONST = "Enumerated"
CHOICE_CONST = "Choice"
SELECTORS = (ENUMERATED_CONST, CHOICE_CONST)
# Structured
ARRAY_CONST = "Array"
...
MAPOF_CONST = "MapOf"
RECORD_CONST = "Record"
STRUCTURES = (ARRAY_CONST, ARRAYOF_CONST, MAP_CONST, MAPOF_CONST, RECORD_CONST)
JADN_TYPES = PRIMITIVES + SELECTORS + STRUCTURES
